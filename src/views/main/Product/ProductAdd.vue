<template>
  <el-dialog title="添加产品" :visible.sync="dialogAddVisible" 
    ...
    <el-form label-width="70px" :model="addForm" ref="addForm">
      <el-form-item label="商品类目">
        <el-button type="primary" class="location"
          @click="dialogCategoryHandle">类目选择
        </el-button>
          ...
          <ProductTree @onTree="getTreeData" />
            <span slot="footer" class="dialog-footer">
                <el-button type="primary" 
                  @click="dialogCategoryVisible = false">确 定
                </el-button>
            </span>
        </el-dialog>
      </el-form-item>
      ...
      <el-form-item label="商品图片">
          <el-button type="primary" class="location"
            ...
            :visible.sync="dialogUploadVisible">
                <!-- onUpload由ProductWangEditor的$emit触发 -->
